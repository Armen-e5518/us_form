...
<div id="fb-root" class=" fb_reset">
    ...
    <div class="container">
        <p class="breadcrumbs"><span xmlns:v="http://rdf.data-vocabulary.org/#">
                <span typeof="v:Breadcrumb"><a href="https://am.usembassy.gov/" rel="v:url" property="v:title">Home</a> | <span
                            class="breadcrumb_last">Form</span></span></span>
        </p>
        <div class="opluade-file">
            <h2>Import form file</h2>
            <input style="margin: 14px -5px;" type="file" name="fileToUpload" id="xml-file">
<!--            <button class="btn btn-success" >Import</button>-->
            <button id="xml-submit" type="button" class="btn btn-success">
                <i style="display:none;font-size:24px" class="fa fa-spinner loading fa-spin"></i>
                Import
            </button>
        </div>
    </div>
                    ...
                    <div class="demo" id="user-view" style="display: none;">
                        <form id="data-form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="save-button">
                                <button id="save-xml" type="button" class="btn btn-success">
                                    <i style="display:none;font-size:24px" class="fa fa-spinner  fa-spin"></i>
                                    Save form
                                </button>
                                <button id="save-data" type="button" class="btn btn-success">
                                    <i style="display:none;font-size:24px" class="fa fa-spinner loading fa-spin"></i>
                                    Submit
                                </button>
                            </div>
    ...
    <script type="text/javascript" async=""
            src="<?= Yii::$app->urlManager->baseUrl ?>/js/UploadeXmlFile.js"></script>
