    ...
    <div class="sidebar-nav">
        ...
        <ul class="nav nav-list accordion-group">
            ...
            <li class="rows" id="estRows">
                    ...
                    <span class="configuration">
                        <span class="btn-group btn-group-xs n-empty">
                            <i style="font-size: 20px;"
                               title="Text Color"
                               class="glyphicon glyphicon-text-background  i_background_ley"></i>
					    </span>
                    </span>
                    <div class="preview">
                ...
                <div class="lyrow ui-draggable">
                    <a href="#close" class="remove label label-danger">
                        <i class="glyphicon-remove glyphicon"></i>delete
                    </a>
                    <span class="drag label label-default">
        ...
        <ul class="nav nav-list accordion-group">
            ...
            <li class="boxes" id="elmBase">
                ...
                <div class="box box-element ui-draggable">
                    ...
                    <span class="configuration">
                        <span class="btn-group btn-group-xs n-empty">
                            ...
                            <i style="font-size: 20px;"
                               ...
                               class="glyphicon glyphicon-text-background i_background_color"></i>
                            <i style="font-size: 20px;"
                               title="Text Color"
                               class="glyphicon glyphicon-text-color i_text_color"></i>
                            <select class="i_font_weight" style="max-width: none;">
                             ...
                             <select class="i_font_style" style="max-width: none;">
                    ...
                    <div class="view">
                        <div>
                            <h1 class="editable_object">Text h1</h1>
                        </div>
                    </div>
                </div>
                <div class="box box-element ui-draggable">
                    ...
                    <div class="view">
                        <div>
                            <h2 class="editable_object">Text h2</h2>
                        </div>
                    </div>
                </div>
                <div class="box box-element ui-draggable">
                    ...
                    <div class="view">
                        <div>
                            <h3 class="editable_object">Text h3</h3>
                        </div>
                    </div>
                </div>
                <div class="box box-element ui-draggable">
                    ...
                    <div class="view">
                        <div>
                            <h4 class="editable_object">Text h4</h4>
                        </div>
                    </div>
                </div>
                <div class="box box-element ui-draggable">
                ...
                <div class="lyrow box-element ui-draggable">
                    ...
                    <span class="configuration">
                        <span class="btn-group btn-group-xs n-empty">
                            <i style="font-size: 20px;"
                               title="Background Color"
                               class="glyphicon glyphicon-text-background table_background_color"></i>
					    </span>
                    </span>
                    <div class="preview">
